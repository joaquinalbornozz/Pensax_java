<%-- 
    Document   : editar
    Created on : 13 nov 2024, 12:30:44
    Author     : users
--%>
...
<body class="bg-light">
    ...
    <div class="container my-5 p-5 bg-white rounded-lg shadow-lg">
        <!-- Header -->
        <div class="mb-4">
            <h2 class="font-semibold text-xl text-dark text-center">Editar Carrera</h2>
        </div>
        ...
        <!-- Edit Form -->
        <form method="POST" action="${pageContext.request.contextPath}/carreras/editar?id=${carrera.getIdCarrera()}" class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <!-- Title Input -->
            <div class="mb-3">
                <label for="titulo" class="form-label">Título</label>
                <input type="text" name="titulo" id="titulo" class="form-control" 
                       value="${(param.titulo) != null ? (param.titulo) : carrera.getTitulo()}">
            </div>
